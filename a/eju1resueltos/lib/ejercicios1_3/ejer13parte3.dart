...
Future<void> parte3ejercicios1y2() async {
  ...
  DirectorioAditivos dirAditivos =
      await DirectorioAditivos.load(path: "data/aditivos.json");

  // Se muestran los 15 primeros aditivos del directorio. Para que salgan todos, eliminar la llamada a take(20)
